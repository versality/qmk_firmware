...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,    KC_Z,    KC_X,    KC_C,     KC_D,   KC_V,         KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_QUOT,  KC_BSLS,
                KC_LBRC, KC_RBRC, KC_LSFT,  KC_BSPC,                       ALT_SPC, SFT_ENT, KC_MINS, KC_EQL,
                         OSL(3),  KC_TAB,   MO(1),                         OSL(3),  KC_DEL,  KC_LGUI
    ),
    [1] = LAYOUT(
    _______,   QK_BOOT, M_PREV,  KC_MU,   M_NEXT,   _______,      KC_HOME, KC_PAGE_DOWN, KC_PAGE_UP, KC_END,  KC_CAPS, _______,
    _______,   _______, KC_ML,   KC_MD,   KC_MR,    _______,      KC_LEFT, KC_DOWN,      KC_UP,      KC_RGHT, _______, _______,
    _______,   _______, _______, KC_MB2,  KC_MB1,   _______,      _______, _______,      _______,    KC_QUES, KC_PIPE, _______,
